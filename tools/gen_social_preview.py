#!/usr/bin/env python3
"""
Generate GitHub social preview image for ArchiLudo.
Same layout as locifilemanager-v2/OricScreenEditorLOCI/oricdemo2026/
heartbeat-demo/vdcmaniac's own screenshots/social-preview.png.
...
# --- Paths ---
SCREEN_SHOT    = os.path.join(REPO_ROOT, 'screenshots', 'main-interface.png')
...
# heartbeat-demo/vdcmaniac layout) ---
...
# Text positions (y baselines matching FM/OSE/oricdemo2026/heartbeat-demo/vdcmaniac layout)
...
# --- Load the main interface screenshot ---
...
# Paste main interface screenshot (with 4px green border)
border = 4
draw.rectangle(
...
draw.text((TEXT_X, URL_Y),    "github.com/xahmol/ArchiLudo", font=font_url, fill=C_GREEN)
