...
# Old-style RISC OS screen/sprite mode numbers, by (bits-per-pixel, OS-unit
# pixel size) -- RISC OS 3 PRM, Chapter 22, "Sprite modes" table.
MODES_BY_BPP = {
...
def cmd_from_png(args):
    bpp = args.bpp or {0: 1, 8: 2, 12: 4, 15: 8}.get(args.mode, 4)
